...
"Clean guides" (script)clears all guides in your scene(generally not needed after a rig is 
    ...
    '_guide' from scene'''
        ...
        cmds.button (label='template biped', p='listBuildButtonLayout', command = self.template_guides)  
        cmds.button (label='template qu', p='listBuildButtonLayout', command = self.template_quad_hoof_guides)  
