...
#         else:
        ...
        cmds.parentConstraint( "End"+mainName+"IK_Ctrl", getMiddleClusters[1][-1:], mo=1, w=1)
        cmds.parentConstraint( mainName+"Secondary_IK_Ctrl", getMiddleClusters[1][-1:], mo=1, w=0)
        cmds.parentConstraint( "End"+mainName+"IK_Ctrl", getMiddleClusters[1][-2:-1] , mo=1, w=1)
        cmds.parentConstraint(mainName+"Secondary_IK_Ctrl", getMiddleClusters[1][-2:-1] , mo=1, w=0)
