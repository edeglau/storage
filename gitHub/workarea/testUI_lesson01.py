...
class typicalWindow(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        # self.listWidg.setColumnWidth(3, 10)
    ...
    def listCreate(self):
        ...
        self.listWidg.setColumnWidth(3, 6)
        ...
        for row, item in enumerate(fileDict):
            ...
            # self.listWidg.insertRow(rowPosition)            
            ...
            # tableWidget.insertRow(currentRowCount, 0, QTableWidgetItem(key))

            # name=QtGui.QTableWidgetItem(key)

            # tableWidget.setItem(currentRowCount, 0, QTableWidgetItem(key))
